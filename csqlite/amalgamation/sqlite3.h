...
**
** The name of this file under configuration management is "cpp_sqlite.h.in".
...
** <dd>This option is only available if cpp_sqlite is compiled with the
...
** and the WAL file.
**
** If F is the name of an cpp_sqlite database file, journal file, or WAL file
