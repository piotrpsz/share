...
//    auto const value_size =  static_cast<value_size_t>(serde::ser_size(value));
//    total_size_t const total_size = sizeof(total_size_t) + sizeof(name_size_t) + name_size + value_size;
//
//    vec<u8> buffer;
